...
GAPS: dict[str, Gap] = {
    "error-messages": Gap(
        reason=(
            ...
            "basename, not argv[0]) and <path> is the operand as typed or the walk path; a directory operand "
            "without -r or -d gets the fixed text 'is a directory'. remmy prints \"cannot remove 'x': ...\" and "
            "\"cannot open 'x': ...\"."
        ),
        cases=frozenset(
            {
                "test_rm_parity_cli.py::test_P_W_x[rW_missing]",
                "test_rm_parity_cli.py::test_directories[dir_no_r]",
                "test_rm_parity_cli.py::test_directories[dir_no_r_f]",
                "test_rm_parity_cli.py::test_directories[emptydir_no_r]",
                "test_rm_parity_cli.py::test_directories[v_symlink_to_dir_nor_slash]",
                "test_rm_parity_cli.py::test_dot_and_slash_guards[dir_trailing_slash_nor]",
                "test_rm_parity_cli.py::test_dot_and_slash_guards[file_trailing_slash]",
                "test_rm_parity_cli.py::test_dot_and_slash_guards[file_trailing_slash_f]",
                "test_rm_parity_cli.py::test_dot_and_slash_guards[missing_trailing_slash]",
                "test_rm_parity_cli.py::test_dot_and_slash_guards[slashslash_nor]",
                "test_rm_parity_cli.py::test_interactive_i[i_dir_no_r]",
                "test_rm_parity_cli.py::test_invocation_names[argv0_custom_string]",
                "test_rm_parity_cli.py::test_invocation_names[argv0_custom_unlink_path]",
                "test_rm_parity_cli.py::test_invocation_names[argv0_custom_unlink_string]",
                "test_rm_parity_cli.py::test_invocation_names[argv0_empty]",
                "test_rm_parity_cli.py::test_invocation_names[argv0_symlink_remmy_missing]",
                "test_rm_parity_cli.py::test_invocation_names[argv0_symlink_rm_dir]",
                "test_rm_parity_cli.py::test_invocation_names[argv0_symlink_rm_missing]",
                "test_rm_parity_cli.py::test_invocation_names[unlink_dir]",
                "test_rm_parity_cli.py::test_invocation_names[unlink_empty_string]",
                "test_rm_parity_cli.py::test_invocation_names[unlink_emptydir]",
                "test_rm_parity_cli.py::test_invocation_names[unlink_missing]",
                "test_rm_parity_cli.py::test_invocation_names[unlink_mode_ro_dir_parent]",
                "test_rm_parity_cli.py::test_invocation_names[unlink_mode_trailing_slash]",
                "test_rm_parity_cli.py::test_invocation_names[unlink_mode_uchg]",
                "test_rm_parity_cli.py::test_legacy_command_mode[legacy_dir_no_r]",
                "test_rm_parity_cli.py::test_legacy_command_mode[legacy_i_missing]",
                "test_rm_parity_cli.py::test_operands[dash_operand_alone_missing]",
                "test_rm_parity_cli.py::test_operands[dash_operand_missing]",
                "test_rm_parity_cli.py::test_operands[empty_string]",
                "test_rm_parity_cli.py::test_operands[empty_string_and_file]",
                "test_rm_parity_cli.py::test_operands[err_odd_names]",
                "test_rm_parity_cli.py::test_operands[missing_and_present]",
                "test_rm_parity_cli.py::test_operands[missing_file]",
                "test_rm_parity_cli.py::test_override_prompts[ro_emptydir_nor_pty]",
                "test_rm_parity_cli.py::test_override_prompts[uchg_file_devnull]",
                "test_rm_parity_cli.py::test_override_prompts[uchg_file_f]",
                "test_rm_parity_cli.py::test_override_prompts[uchg_file_rf]",
                "test_rm_parity_cli.py::test_prompt_once_I[I_4_three_exist]",
                "test_rm_parity_cli.py::test_prompt_once_I[I_4operands_missing]",
                "test_rm_parity_cli.py::test_prompt_once_I[I_dir_nor]",
                "test_rm_parity_cli.py::test_prompt_once_I[I_r_missing_dir]",
                "test_rm_parity_cli.py::test_usage_and_getopt[dash_then_opt]",
                "test_rm_parity_cli.py::test_usage_and_getopt[double_dashdash]",
                "test_rm_parity_cli.py::test_usage_and_getopt[operand_dashdash_after]",
                "test_rm_parity_cli.py::test_usage_and_getopt[opt_after_operand_f]",
                "test_rm_parity_cli.py::test_usage_and_getopt[opt_after_operand_r_dir]",
                "test_rm_parity_cli.py::test_usage_and_getopt[opt_after_operand_v]",
                "test_rm_parity_cli.py::test_usage_and_getopt[opt_after_operand_v_posixly]",
                "test_rm_parity_cli.py::test_usage_and_getopt[unknown_]",
                "test_rm_parity_cli.py::test_usage_and_getopt[unknown_after_operand]",
                "test_rm_parity_edges.py::test_P_and_W[P_uchg]",
                "test_rm_parity_edges.py::test_cwd_and_dot_shapes[slashes_only_f]",
                "test_rm_parity_edges.py::test_cwd_and_dot_shapes[slashes_only_nor]",
                "test_rm_parity_edges.py::test_length_boundaries[name_255_missing]",
                "test_rm_parity_edges.py::test_length_boundaries[name_256_in_dir_f]",
                "test_rm_parity_edges.py::test_length_boundaries[path_1023_missing]",
                "test_rm_parity_edges.py::test_length_boundaries[path_1023_missing_r]",
                "test_rm_parity_edges.py::test_length_boundaries[path_1024_missing]",
                "test_rm_parity_edges.py::test_length_boundaries[path_1024_missing_f]",
                "test_rm_parity_edges.py::test_length_boundaries[path_1024_missing_r]",
                "test_rm_parity_edges.py::test_misc[r_error_newline_name_in_tree]",
                "test_rm_parity_edges.py::test_symlinks_to_directories[r_dangling_symlink_slash]",
                "test_rm_parity_edges.py::test_symlinks_to_directories[r_symlink_to_file_slash]",
                "test_rm_parity_edges.py::test_unlink_mode[unlink_dashdash_dash_z]",
                "test_rm_parity_edges.py::test_unlink_mode[unlink_legacy_dir]",
                "test_rm_parity_edges.py::test_unlink_mode[unlink_legacy_missing]",
                "test_rm_parity_edges.py::test_unlink_mode[unlink_name_too_long]",
                "test_rm_parity_edges.py::test_unlink_mode[unlink_symlink_to_dir_slash]",
                "test_rm_parity_fs.py::test_file_flags[fs_uchg_file_f]",
                "test_rm_parity_fs.py::test_file_flags[uappnd_dir_rf]",
                "test_rm_parity_fs.py::test_file_flags[uappnd_file]",
                "test_rm_parity_fs.py::test_file_flags[uappnd_file_f]",
                "test_rm_parity_fs.py::test_file_flags[uchg_dir_r]",
                "test_rm_parity_fs.py::test_file_flags[uchg_dir_rf]",
                "test_rm_parity_fs.py::test_file_flags[uchg_file]",
                "test_rm_parity_fs.py::test_file_flags[uchg_file_fv]",
                "test_rm_parity_fs.py::test_file_flags[uchg_file_in_0555_dir_f]",
                "test_rm_parity_fs.py::test_file_flags[uchg_file_v]",
                "test_rm_parity_fs.py::test_file_flags[uchg_in_tree_r]",
                "test_rm_parity_fs.py::test_file_flags[uchg_subdir_rf]",
                "test_rm_parity_fs.py::test_file_flags[uchg_symlink]",
                "test_rm_parity_fs.py::test_file_flags[uchg_symlink_f]",
                "test_rm_parity_fs.py::test_invocation_names[argv0_arbitrary_name]",
                "test_rm_parity_fs.py::test_invocation_names[argv0_symlink_remmy]",
                "test_rm_parity_fs.py::test_invocation_names[argv0_symlink_rm]",
                "test_rm_parity_fs.py::test_invocation_names[argv0_symlink_unlink_dir]",
                "test_rm_parity_fs.py::test_invocation_names[argv0_symlink_unlink_missing]",
                "test_rm_parity_fs.py::test_invocation_names[exe_remmy_argv0_rm]",
                "test_rm_parity_fs.py::test_invocation_names[exe_rm_argv0_unlink_dir]",
                "test_rm_parity_fs.py::test_invocation_names[exe_rm_argv0_unlink_one_missing]",
                "test_rm_parity_fs.py::test_invocation_names[exe_unlink_argv0_frob_two_operands]",
                "test_rm_parity_fs.py::test_length_limits[deep_existing_operand_too_long]",
                "test_rm_parity_fs.py::test_length_limits[deep_existing_operand_too_long_f]",
                "test_rm_parity_fs.py::test_length_limits[name_too_long]",
                "test_rm_parity_fs.py::test_length_limits[name_too_long_f]",
                "test_rm_parity_fs.py::test_length_limits[name_too_long_r]",
                "test_rm_parity_fs.py::test_length_limits[path_too_long_missing]",
                "test_rm_parity_fs.py::test_length_limits[path_too_long_missing_f]",
                "test_rm_parity_fs.py::test_links_and_special_files[dangling_symlink_slash]",
                "test_rm_parity_fs.py::test_links_and_special_files[symlink_loop_slash]",
                "test_rm_parity_fs.py::test_links_and_special_files[symlink_to_dir_slash]",
                "test_rm_parity_fs.py::test_links_and_special_files[symlink_to_file_slash]",
                "test_rm_parity_fs.py::test_missing_and_directories[empty_string_operand]",
                "test_rm_parity_fs.py::test_missing_and_directories[fs_dir_no_r]",
                "test_rm_parity_fs.py::test_missing_and_directories[fs_dir_no_r_f]",
                "test_rm_parity_fs.py::test_missing_and_directories[fs_dir_no_r_v]",
                "test_rm_parity_fs.py::test_missing_and_directories[fs_missing_and_present]",
                "test_rm_parity_fs.py::test_missing_and_directories[fs_missing_file]",
                "test_rm_parity_fs.py::test_missing_and_directories[missing_file_r]",
                "test_rm_parity_fs.py::test_missing_and_directories[missing_file_v]",
                "test_rm_parity_fs.py::test_missing_and_directories[missing_in_missing_dir]",
                "test_rm_parity_fs.py::test_missing_and_directories[nonempty_dir_no_r]",
                "test_rm_parity_fs.py::test_names[name_non_utf8_missing]",
                "test_rm_parity_fs.py::test_names[name_unicode_missing]",
                "test_rm_parity_fs.py::test_path_shapes[absolute_missing]",
                "test_rm_parity_fs.py::test_path_shapes[dir_trailing_slash_no_r]",
                "test_rm_parity_fs.py::test_path_shapes[fifo_trailing_slash]",
                "test_rm_parity_fs.py::test_path_shapes[file_trailing_slash_r]",
                "test_rm_parity_fs.py::test_path_shapes[fs_file_trailing_slash]",
                "test_rm_parity_fs.py::test_path_shapes[fs_file_trailing_slash_f]",
                "test_rm_parity_fs.py::test_path_shapes[path_through_file]",
                "test_rm_parity_fs.py::test_path_shapes[path_through_file_f]",
                "test_rm_parity_fs.py::test_path_shapes[path_through_file_r]",
                "test_rm_parity_fs.py::test_path_shapes[socket_trailing_slash]",
                "test_rm_parity_fs.py::test_permissions[file_in_0555_dir]",
                "test_rm_parity_fs.py::test_permissions[file_in_0555_dir_f]",
                "test_rm_parity_fs.py::test_permissions[file_in_0555_dir_v]",
                "test_rm_parity_fs.py::test_permissions[lookup_missing_through_0000_dir_f]",
                "test_rm_parity_fs.py::test_permissions[lookup_through_0000_dir]",
                "test_rm_parity_fs.py::test_permissions[lookup_through_0000_dir_f]",
                "test_rm_parity_fs.py::test_permissions[r_0555_dir]",
                "test_rm_parity_fs.py::test_permissions[r_empty_operand_0000]",
                "test_rm_parity_fs.py::test_permissions[r_empty_subdir_0000]",
                "test_rm_parity_fs.py::test_permissions[r_nested_0000_two]",
                "test_rm_parity_fs.py::test_permissions[r_operand_0000]",
                "test_rm_parity_fs.py::test_permissions[r_subdir_0000]",
                "test_rm_parity_fs.py::test_permissions[r_subdir_0333]",
                "test_rm_parity_fs.py::test_permissions[r_subdir_0555]",
                "test_rm_parity_fs.py::test_permissions[rf_0555_dir]",
                "test_rm_parity_fs.py::test_permissions[rf_subdir_0000]",
                "test_rm_parity_fs.py::test_permissions[rf_subdir_0555]",
            }
        ),
    ),
    "force": Gap(
        ...
        cases=frozenset(
            {
                ...
                "test_rm_parity_cli.py::test_interactive_i[fi_missing]",
                "test_rm_parity_cli.py::test_interactive_i[iI_file]",
